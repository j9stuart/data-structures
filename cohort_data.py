def unique_houses(filename):
    ...
    # iterate over file_data to glean each line using for loop
    for line in file_data:

        data_points = line.split("|")
        house_name = data_points[2]
...
def sort_by_cohort(filename):
    ...
    for line in file_data:
        ...
        if data_points[4] == "Winter 2016":
            full_name = data_points[0] + " " + data_points[1]
            winter_16.append(full_name)
        
        elif data_points[4] == "Spring 2016":
            full_name = data_points[0] + " " + data_points[1]
            spring_16.append(full_name)
            
        elif data_points[4] == "Summer 2016":
            full_name = data_points[0] + " " + data_points[1]
            summer_16.append(full_name)
           
        elif data_points[4] == "Fall 2015":
            full_name = data_points[0] + " " + data_points[1]
